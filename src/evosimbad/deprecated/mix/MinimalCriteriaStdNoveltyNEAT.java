 ...
 * @author Jorge
 */
public class MinimalCriteriaStdNoveltyNEAT extends StandardizedNoveltyNEAT {

    private PMCNS pmcns;
    
    public MinimalCriteriaStdNoveltyNEAT(int numberGenerations, int k, double tInitial, double percentile, double adjust) {
