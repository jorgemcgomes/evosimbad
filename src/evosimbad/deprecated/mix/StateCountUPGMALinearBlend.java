 ...
 * @author jorge
 */
public class StateCountUPGMALinearBlend extends StateCountUPGMA {

    private LinearBlend blend;

    public StateCountUPGMALinearBlend(int numberGenerations, int k, double tInitial, double noveltyRatio, double cutoff) {
