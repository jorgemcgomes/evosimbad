 ...
 * @author jorge
 */
public class StateCountBrayCurtisPMCNS extends StateCountBrayCurtis {

    private PMCNS pmcns;

    public StateCountBrayCurtisPMCNS(int numberGenerations, int k, double tInitial, double percentile, double adjust, double cutoff) {
