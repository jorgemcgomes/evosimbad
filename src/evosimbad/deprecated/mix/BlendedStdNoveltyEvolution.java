 ...
 * @author Jorge
 */
public class BlendedStdNoveltyEvolution extends StandardizedNoveltyNEAT {

    private LinearBlend blend;
    
    public BlendedStdNoveltyEvolution(int numberGenerations, int k, double tInitial, double noveltyRatio) {
