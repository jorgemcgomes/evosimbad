 ...
 * @author jorge
 */
public class StateCountBrayCurtisLinearBlend extends StateCountBrayCurtis {

    private LinearBlend blend;

    public StateCountBrayCurtisLinearBlend(int numberGenerations, int k, double tInitial, double noveltyRatio, double cutoff) {
