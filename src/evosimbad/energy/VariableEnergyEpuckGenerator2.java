 ...
 * @author jorge
 */
public class VariableEnergyEpuckGenerator2 extends VariableAgentGenerator {
    ...
    public VariableEnergyEpuckGenerator2(int min, int max, float stationSensorRange, double initialLevel, double maxLevel, double minDropRate, double maxDropRate) {
        super(min, max);
