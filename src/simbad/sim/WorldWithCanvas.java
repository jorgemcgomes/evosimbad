...
public class WorldWithCanvas {
    ...
    public WorldWithCanvas(EnvironmentDescription ed, boolean offScreen) {
    ...
    public void changeEnvironment(EnvironmentDescription newEnv) {
        locale.removeBranchGraph(sceneBranch);
        createSceneBranch(newEnv);
    ...
    private void createCanvas3D() {
        ...
        // create canvas
        canvas3d = new Canvas3D(config, offScreen);
